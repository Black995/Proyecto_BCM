    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scale', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='scale_service_offered', to='bcm_phase2.scale')),
            ],
        ),
        migrations.CreateModel(
            name='ServiceUsed',
            fields=[
                ...
                ('scale', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='scale_service_used', to='bcm_phase2.scale')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True)),
                ('scale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scale_view', to='bcm_phase2.scale')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scale', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='scale_organization_activity', to='bcm_phase2.scale')),
