...
export function setRecoveryTime(duration: Duration) {
	let day = ''
	let hour = ''
	let minute = ''
...
export function getRecoveryTime(durationText: string) {
...
export function getRecoveryTimeText(durationText: string) {
